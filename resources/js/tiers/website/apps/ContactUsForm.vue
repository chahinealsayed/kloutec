...
const { redirectUrl = "", title, subtitle, longitude, latitude, embed } = defineProps<Props>();
...
class ContactForm extends Model {
    ...
    get rules(): any[] {
        return [
            ...
            [[this.name, this.email, this.message, this.phone], RequiredRule],
        ];
    }
}
...
<template>
    <section class="form" style="padding-left: 0;">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="cont">
                    ...
                    <form v-if="model" @submit.prevent="send" class="contact-us-form-vue">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div style="position: relative;" class="col-md-6">
                    <div class="h-100" v-html="embed"></div>
                    <div
                        style="background: linear-gradient(90deg, #FFF 14.58%, rgba(255, 255, 255, 0.00) 100%); position: absolute; top: 0; height: 100%;width: 20%;">
                    </div>
                </div>
            </div>
            <div class="box1"></div>
