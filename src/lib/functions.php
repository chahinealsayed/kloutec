...
function sideMenu()
{
    return [
        [
            'label' => 'About Us',
            'url' =>  Url::to(['default/content', 'id' => 'cms.contents.default.about-us.1']),
        ...
        [
            'label' => 'Careers',
            'url' =>  Url::to(['default/content', 'id' => 'cms.contents.default.careers']),
            'options' => ['class' => Yii::$app->request->getUrl() === '/Careers' ? 'active' : ''],
        ],
        [
            'label' => 'Contact us',
            'url' =>  Url::to(['default/content', 'id' => 'cms.contents.default.contact']),
            'options' => ['class' => Yii::$app->request->getUrl() === '/Contact-Us' ? 'active' : ''],
